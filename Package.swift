...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "swift-iavlplus", url: "https://github.com/CosmosSwift/swift-iavlplus", .upToNextMajor(from: "0.3.0")),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "InMemoryNodeDB", package: "swift-iavlplus"),
